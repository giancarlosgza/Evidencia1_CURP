package giancarlosgarza.com.evidencia1_curp;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public static final String EXTRA_NOMBRE = "giancarlosgarza.com.evidencia1_curp.EXTRA_NOMBRE";
    public static final String EXTRA_APELLIDOP = "giancarlosgarza.com.evidencia1_curp.EXTRA_APELLIDOP";
    public static final String EXTRA_APELLIDOM = "giancarlosgarza.com.evidencia1_curp.EXTRA_APELLIDOM";
    public static final String EXTRA_FECHA = "giancarlosgarza.com.evidencia1_curp.EXTRA_FECHA";
    public static final String EXTRA_ENTIDAD = "giancarlosgarza.com.evidencia1_curp.EXTRA_ENTIDAD";
    public static final String EXTRA_GENERO = "giancarlosgarza.com.evidencia1_curp.EXTRA_GENERO";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //SPINNER INIT
        Spinner spinner = findViewById(R.id.spinnerEnt);
